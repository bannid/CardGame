...
set Libs=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib opengl32.lib glfw3.lib irrKlang.lib
rem Compile
...
cl /LD  ../game/game.cpp ../card.cpp ../screen.cpp ../animators.cpp ../misc.cpp /I  %Includes%  -Zi /link -PDB:game_%random%.pdb 
popd 